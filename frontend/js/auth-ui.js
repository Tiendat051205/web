...
function updateAuthUI() {
    ...
    if (token && (user.fullName || isAdminUser(user))) {
      ...
      if (userAvatar) {
        userAvatar.src = user.avatarUrl || 'images/default-images.jpeg'; // Thay 'images/default-avatar.png' bằng đường dẫn ảnh mặc định của bạn
      }
  
      // 3. Hiển thị khối Profile & Nút Đăng xuất
